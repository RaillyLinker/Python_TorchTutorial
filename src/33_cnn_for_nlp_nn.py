...
def main():
    ...
    tu.train_model(
        ...
        optimizer=optim.RMSprop(model.parameters(), lr=0.0001, momentum=0.9, weight_decay=0.001),
        train_dataloader=train_dataloader,
        num_epochs=10000,
        validation_dataloader=validation_dataloader,
        check_point_file_save_directory_path="../check_point_files/cnn_sentence_classifier",
        # check_point_load_file_full_path="../check_point_files/~/checkpoint(2024_02_29_17_51_09_330).pt"
    )

    # 모델 저장
    model_file_save_directory_path = "../model_files/cnn_sentence_classifier"
