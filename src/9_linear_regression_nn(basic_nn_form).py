...
"""
[선형 회귀 모델 - 토치 모델]
- 아래 코드는 선형 회귀 모델을 본격적으로 토치 모델로 만들어 사용 하는 예시를 보여 줍니다.
...
def main():
    ...
    dataset = tu.CsvModelDataset(
        csv_file_full_url="../resources/datasets/linear.csv",
    ...
    tu.train_model(
        ...
        check_point_file_save_directory_path="../_check_point_files/linear_regression",
        # check_point_load_file_full_path="../_check_point_files/~/checkpoint(2024_02_29_17_51_09_330).pt",
        log_freq=1000
    )

    # 모델 저장
    model_file_save_directory_path = "../_torch_model_files/linear_regression"
