...
- 가장 기본적인 텍스트 임베딩 방법은 전에 softmax mnist classifier 글에서 설명한 one-hot-encoding 이 있습니다.
    다만, 이미 설명하였듯 이 방식은 희소 표현 문제가 존재합니다.

- 아래로는 희소 표현 문제를 해결하고 밀집 표현으로 정보를 축약하는 데이터 임베딩 기법을 이해하기 위한 기본 지식을 정리하였습니다.
"""
