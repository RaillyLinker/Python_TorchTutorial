"""
[손실 정규화]
- 손실값에 정규화 값을 더하여 기울기 소실 등의 문제를 해결하며 개선 할 수 있습니다.
아래 예시 코드는 L1, L2 정규화 방식을 코드로 나타낸 것으로,
계산 방식을 눈에 익히기 위해 확인을 하면 되며,
실제로는 train_model 함수의 weight_decay 변수(L2 정규화와 동일)를 설정 하여 적용할 수 있습니다.
"""
